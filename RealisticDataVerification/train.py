...
from data_process import modify_output,add_step_noise_to_gsm_fobar
...
def train():
    ...
    # TODO1:test for no-cot
    # print('without cot:')
    # raw_train_datasets = raw_train_datasets.map(modify_output)
    # print(raw_train_datasets[0])
    # TODO2: test for cot-noise
    # print('cot with noise:')
    # raw_train_datasets = raw_train_datasets.map(add_step_noise_to_gsm_fobar)
    # print(raw_train_datasets[666]['output'])
    # print(raw_train_datasets[686]['output'])
    # print(raw_train_datasets[696]['output'])
    # exit()
